...
import (
	"gitlab.com/samli88/go-x11-hash/blake"
	"gitlab.com/samli88/go-x11-hash/bmw"
	"gitlab.com/samli88/go-x11-hash/cubehash"
	"gitlab.com/samli88/go-x11-hash/echo"
	"gitlab.com/samli88/go-x11-hash/groestl"
	"gitlab.com/samli88/go-x11-hash/hash"
	"gitlab.com/samli88/go-x11-hash/jh"
	"gitlab.com/samli88/go-x11-hash/keccak"
	"gitlab.com/samli88/go-x11-hash/luffa"
	"gitlab.com/samli88/go-x11-hash/shavite"
	"gitlab.com/samli88/go-x11-hash/simd"
	"gitlab.com/samli88/go-x11-hash/skein"
)
