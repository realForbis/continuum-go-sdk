...
const (
	// AddressPrefix is the prefix of continuum addresses.
	AddressPrefix = "qu_"
	// AddressSize represents the binary size of a continuum address (a public key).
	AddressSize         = ed25519.PublicKeySize
	addressChecksumSize = 5
	addressPrefixLen    = len(AddressPrefix)
	// AddressLen represents the string length of a continuum address.
	AddressLen = 60
...
var (
	...
	MintageAddress, _    = HexToAddress("qu_3qjky1ptg9qkzm8iertdzrnx9btjbaea33snh1w4g395xqqczye4kgcfyfs1")
	NEP5PledgeAddress, _ = HexToAddress("qu_3fwi6r1fzjwmiys819pw8jxrcmcottsj4iq56kkgcmzi3b87596jwskwqrr5")
	RewardsAddress, _    = HexToAddress("qu_3oinqggowa7f1rsjfmib476ggz6s4fp8578odjzerzztkrifqkqdz5zjztb3")
...
// GenerateAddress generate continuum address
